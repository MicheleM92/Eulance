...
import { 
  CheckCircle2, ShieldCheck, Zap, Scale, Euro, Users, ArrowRight, 
  FileText, Briefcase, Award, Lock, Sparkles, MapPin, Globe, ChevronRight,
  Calculator, Building2, UserCheck
} from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-[var(--color-eulance-border)] shadow-xs mb-8 text-xs font-bold text-[var(--color-eulance-navy)]">
              <span className="w-2.5 h-2.5 rounded-full bg-[var(--color-eulance-emerald)] animate-pulse"></span>
              EU Digital Sovereignty • Phase 1 Iberian Rollout
            </div>
            ...
            <p className="text-lg sm:text-xl text-[var(--color-eulance-muted)] mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                href="/prototype" 
                className="w-full sm:w-auto px-8 py-4 bg-[var(--color-eulance-blue)] text-white rounded-xl font-bold text-base hover:bg-[var(--color-eulance-navy)] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
              ...
              >
                <FileText size={20} className="text-[var(--color-eulance-blue)]" /> {dict.hero.ctaPlan}
              </Link>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-gray-200 shadow-md hover:shadow-lg transition-all">
              <div className="w-10 h-10 rounded-xl bg-blue-50 text-[var(--color-eulance-blue)] flex items-center justify-center font-bold mb-4">
                <Zap size={20} />
              </div>
      ...
      <section className="py-12 bg-[var(--color-eulance-navy)] text-white border-y border-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl sm:text-4xl font-extrabold text-[var(--color-eulance-gold)] mb-1">11.5M+</div>
            ...
            <div>
              <div className="text-3xl sm:text-4xl font-extrabold text-[var(--color-eulance-mint)] mb-1">0%</div>
              <div className="text-xs font-semibold uppercase tracking-wider text-white/70">Freelancer Launch Fee</div>
            </div>
            <div>
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead>
                <tr className="border-b-2 border-gray-200 text-xs font-bold text-[var(--color-eulance-navy)] uppercase">
                  ...
                  <th className="p-4 bg-[var(--color-eulance-soft)] text-[var(--color-eulance-blue)] text-sm rounded-t-xl">
                    EULANCE (EU Platform)
                  </th>
              ...
              <tbody className="divide-y divide-gray-100 text-xs sm:text-sm">
                <tr>
                  ...
                  <td className="p-4 bg-[var(--color-eulance-soft)] font-bold text-[var(--color-eulance-emerald)]">
                    0% (Launch Promo) / 5% max
                  </td>
                  <td className="p-4 text-red-500 font-medium">10% – 20% + Bidding Credits</td>
                  <td className="p-4 text-gray-600">0% (High Chase Risk)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-4 bg-[var(--color-eulance-soft)] font-bold text-[var(--color-eulance-blue)]">
      ...
      <section className="py-20 bg-[var(--color-eulance-soft)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[var(--color-eulance-navy)] mb-4">
              Explore the Prototype Workflows
            </h2>
            <p className="text-base text-[var(--color-eulance-muted)] max-w-2xl mx-auto">
              Test both sides of Europe's fair freelance platform in real-time.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* For Companies */}
            <div className="bg-white p-8 rounded-3xl border-2 border-transparent hover:border-[var(--color-eulance-blue)] transition-all shadow-sm hover:shadow-md flex flex-col justify-between">
              <div>
                <div className="w-14 h-14 bg-[var(--color-eulance-navy)] text-white rounded-2xl flex items-center justify-center mb-6">
                  <Building2 size={28} />
                </div>
                <h3 className="text-2xl font-bold text-[var(--color-eulance-navy)] mb-3">For Companies</h3>
                ...
                <ul className="space-y-3 text-xs font-medium text-gray-700 mb-8">
                  <li className="flex items-center gap-2">
                    ...
                    AI-Matched shortlist in seconds
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-[var(--color-eulance-emerald)] shrink-0" />
              ...
              <Link 
                href="/prototype/client" 
                className="w-full py-3.5 bg-[var(--color-eulance-blue)] hover:bg-[var(--color-eulance-navy)] text-white font-bold rounded-xl text-center text-sm transition-colors shadow-sm flex justify-center items-center gap-2"
              >
                Launch Company Prototype <ArrowRight size={16} />
              </Link>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border-2 border-transparent hover:border-[var(--color-eulance-emerald)] transition-all shadow-sm hover:shadow-md flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-[var(--color-eulance-navy)] mb-3">For Freelancers</h3>
                <p className="text-sm text-[var(--color-eulance-muted)] mb-6 leading-relaxed">
              ...
              >
                Launch Freelancer Prototype <ArrowRight size={16} />
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* CTA Footer Banner */}
      <section className="py-16 bg-gradient-to-r from-[var(--color-eulance-navy)] via-blue-900 to-[var(--color-eulance-navy)] text-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-extrabold mb-4 text-[var(--color-eulance-gold)]">
          ...
          <Link
            href="/business-plan"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[var(--color-eulance-navy)] font-extrabold rounded-xl text-base hover:bg-gray-100 transition-colors shadow-lg"
          >
            <Calculator size={18} /> View Financial Calculator & Roadmap
          </Link>
        </div>
      </section>
    </div>
